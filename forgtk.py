...
class ForgTkException(Exception):
    def __init__(self, message):
        super(ForgTkException, self).__init__(message)
...
class ForgTk(Frame):
    ...
    def getGopherResponse(self):
        ...
        try:
            ...
            raise ForgTkException("Error: " + estr)
            ...
            raise ForgTkException(err)

        if self.response.getError():
            raise ForgTkException(self.response.getError())
    ...
    def downloadResource(self, res):
        ...
        except ForgTkException as estr:
    ...
    def createResponseWidget(self):
        ...
        if not self.response:
            raise(ForgTkException, "createResponseWidget: No valid response present")
        if not self.resource:
            raise(ForgTkException, "createResponseWidget: No valid resource present")
